...
local function playClick()
  sound = audio.play( click )
	...
	local function goHome(event)
	  ...
	  home.x, home.y = display.contentWidth/2, 300
 ...
 local function fieldHandler( event )
    ...
    local text = display.newText("Hello! In order to access this section, which opens a web page, please do a quick math problem: What's 6x7?", 0, 0, 400, 0, "HelveticaNeue-Light", 20 )
  ...
  local function onButtonEvent (event)
      ...
      if answerField.text == '42' then
        system.openURL( "http://snappy.ladeezfirstmedia.com/?page_id=28" )
       else
