...
function scene:create( event )
	...
	bg = display.newImageRect( sceneGroup, "images/snowy2.png", display.contentWidth, display.contentHeight )
	bg.anchorX = 0
	bg.anchorY = 0
	bg.x, bg.y = 0, 0
	...
	local both = display.newImageRect("images/both.png",281,216)
	both.x,both.y = display.contentWidth/2,display.contentHeight-50
	sceneGroup:insert(both)
	...
	local options = 
				{
				   text = "Auntie Pip said he could use some of his nuts to buy part of the Deer Brothers’ Lawn Service.  They take care of lawns, like keeping the grass cut, pushing leaves off of the trails, and trampling down snow, but they need to buy some tools to make their business work better.",  
				   fontSize = 12,
	...
	local helperOptions = {
				   text = "What local companies sell shares in their business?",     
				   fontSize = 14,
				   width = 100,
				   font="Times",
				}
