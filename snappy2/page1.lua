...
function scene:create( event )
	...
	bg = display.newImageRect( sceneGroup, "images/leafshelterbg.png", display.contentWidth, display.contentHeight )
	bg.anchorX = 0
	bg.anchorY = 0
	bg.x, bg.y = 0, 0
	sceneGroup:insert(bg)

	local snappy_cold = display.newImageRect("images/snappy_cold_flipsm.png",88,114)
	snappy_cold.x,snappy_cold.y = display.contentWidth/2+60,display.contentHeight-60
	...
	local helperOptions = {
				   text = "How much is your home worth?",     
				   fontSize = 14,
				   width = 100,
				   font="Times",
				}
