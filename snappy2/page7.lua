...
function scene:create( event )
	...
	bg = display.newImageRect( sceneGroup, "images/snowy4.png", display.contentWidth, display.contentHeight )
	bg.anchorX = 0
	bg.anchorY = 0
	bg.x, bg.y = 0, 0
	...
	local pip_cold = display.newImageRect("images/pip_cold.png",210,255)
	pip_cold.x,pip_cold.y = display.contentWidth/2,display.contentHeight-50
	sceneGroup:insert(pip_cold)
	...
	local options = 
				{
				   text = "Snappy thought that sharing a business, especially one he doesn’t run himself, sounded great. Auntie Pip provided more information, “These shares in the company are called 'common stocks' because anybody can buy them.”  A share of the Deer Brothers’ business is one nut of the business’s profit.  Snappy learned that he can buy a share of this company for only ten nuts.",  
				   fontSize = 12,
	...
	local helperOptions = {
				   text = "Does your family own any common stock?",     
				   fontSize = 14,
				   width = 100,
				   font="Times",
				}
